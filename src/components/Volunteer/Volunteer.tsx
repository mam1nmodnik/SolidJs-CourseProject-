            ...
            <div class={cs.content}>
                <div class={cs.flex} >
                    <div>
                        <p class={cs.text}>
                            ...
                            <span class={cs.bgText}>Заполнить анкету</span>
                        </p>
                    </div>
                    <div>
                        <p class={cs.text}>
                            <span class={cs.number}>3.  </span>
                            <span class={cs.bgText}>Назначить встречу </span> поиска вместе<br/> с отрядом добровольцев
                        </p>
                    </div>
                </div>
                <div class={cs.containerLine}>
                    
                    <svg  class={`${cs.line} ${cs.line1}`} xmlns="http://www.w3.org/2000/svg" width="303" height="129" viewBox="0 0 303 129" fill="none">
                    ...
                    <svg class={`${cs.line} ${cs.line2}`} xmlns="http://www.w3.org/2000/svg" width="177" height="153" viewBox="0 0 177 153" fill="none">
                    ...
                    <svg class={`${cs.line} ${cs.line3}`} xmlns="http://www.w3.org/2000/svg" width="122" height="100" viewBox="0 0 122 100" fill="none">
                ...
                <div class={cs.flex}>
                    <div>
                        <p class={cs.text}>
                            ...
                            <span class={cs.bgText}>Дождаться звонка </span>  от<br/> главного по поискам
                        </p>
                    </div>
                    <div>
                        <p class={cs.text}>
                            <span class={cs.number}>4. </span>
                            <span class={cs.bgText}>Прийти на встречу</span> и <br/><span class={cs.bgText}>получить снаряжение</span>
                        </p>
                    </div>
                </div>

                <div class={cs.containerLine}>  
                    <svg class={`${cs.line} ${cs.line4}`} xmlns="http://www.w3.org/2000/svg" width="357" height="84" viewBox="0 0 357 84" fill="none">
                ...
                <div> 
                    <p class={cs.text}>
                        ...
                        <span class={cs.bgText}>Пойти на поиски </span> пропавшего вместе с <br/> отрядом
                    </p>  
                </div>
            </div>    
