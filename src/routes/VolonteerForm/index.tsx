...
export default function VolonteerForm(){
    ...
    return ( 
            <div class="input-area mt-140px">
                <div>        
                    <h2>Анкета добровольца</h2>
                    <h4 class="label_h4_white">Заполните анкету и с вами свяжутся</h4>  
                            ...
                            <div>
                                ...
                                <div class="input__file">
                                    <div class={`${!file().fileName ? "": "hidden"} input__checkbox` }  onClick={submitVisibleFile} >
                                        ...
                                        <label for="checkbox" class={`${!file().fileName? "": "hidden "} cursor-pointer`}> Прикрепить фото</label>
                                    </div>
                                    <input 
                                        type="file"
                                        accept=".jpg,.png,.gif"
